Big O notation :
O(1) - постоянная   !!! (код, который не зависит от размера данных)
O(n) - linear (одинарные циклы с простым кодом внутри, например линейный поиск)
O(n^2) - quadratic (цикл в цикле(в зависимости от входных данных), обход
...
[6,7,3,5,7,4,3,2,1,9,12,14]
find 12 : return true if is exists

k = 12;
[6,7,3,5,7,4,3,2,1,9,12,14]
[12,7,3,5,7,4,3,2,1,9,5,14]
[6,7,3,5,7,4,3,2,1,9,11,12]
[6,7,3,5,7,4,12,2,1,9,8,14]
...
Comp 2: 0.002, 0.002, 0.002 = 0.02  = O(1)
...
function getSum(){   //  public static int getSum()
    sum = 0;   // 1
...
Принято все числа у параметра тоже отбрасывать

1 + 1 + n + n + n + 1 = 3 + 3n = 3n = O(n)
